...
<div class='main'>
<center><h1 class="my">Architecture</h1></center>
</div>
...
<div class="box">
            ...
            <div class="content">
                <h6 class="h3">{{$data->package}}</h6>

            <h6 class="h3">₹{{$data->price}}</h6>
            <h1 class="h4"><a href="book_arc/{{$data->id}}" class="btn" >Book Now</a></h1>
