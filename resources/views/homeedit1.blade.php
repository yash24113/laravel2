    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas bg-gradient-danger"  id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                 <h1> <li class="nav-item"> <a class="nav-link" href=""><h3>First Slider</h3></a></li>
        ...
        <div class="main-panel">
          <div class="d">
            <div class="y">
        	<center><h1 style="color:white">Update & Remove Home Slider</h1>
        	<br><br><br><br>
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              ...
              <td>
                <a href="homeupdate1/{{$data->id}}" class="btn btn-primary" style="background-color:#2874f0;">Edit</a>
                <a href="homedelete1/{{$data->id}}" class="btn btn-danger">Delete</a>
              </td>
            </tr>
            @endforeach
          </tbody>
