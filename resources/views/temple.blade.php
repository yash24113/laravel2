...
<center><h1 class="my">Temple</h1></center>
</div>
...
<section>
    <div class="d">
          <div class="y">
         <center style="color:white;font-size: 100px;padding-top:50px"> </center>
         <br><br><br><br>
         <div class="tt">
...
<div class="box-container">
 ...
 <div class="box">
       @foreach ($data as $in)
         <div class="yy">
<!-- <div class="box">
 -->            <img src="{{ asset('images/'  . $in->image) }}"  id="pic" object-fit="cover" class="img">
                     <div class="contentt">
                            <h1 class="h3">{{$in->package}}</h1>

                             <h1 class="h3">₹{{$in->price}}</h1>
