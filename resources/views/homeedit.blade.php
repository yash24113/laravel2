    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas bg-gradient-danger"  id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="boat_disp"><h4>Manage Page</h4></a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"><h3>Boat</h3>
                <ul class="nav flex-column sub-menu">

              <li class="nav-item"> <a class="nav-link" href="boat_form"><h3>Add</h3></a></li>
              <li class="nav-item"> <a class="nav-link" href="#"><h3>Update </h3></a></li>
              <li class="nav-item"> <a class="nav-link" href="boat_disp"><h3>Delete</h3></a></li> 
                </ul>
              </li>
        ...
        <div class="main-panel">
          <div class="d">
            <div class="y">
        	<center><h1>Update & Remove Home Slider</h1>
        	<br><br><br><br>
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              ...
              <th>{{$data->id}}</th>
              <td><img src="{{asset('images/' . $data->image) }}" height="40px" width="40px" />
              </td>
              <td>
                <a href="update1/{{$data->id}}" class="btn btn-primary" style="background-color:#2874f0;">Edit</a>
              
              
                <a href="delete1/{{$data->id}}" class="btn btn-danger">Delete</a>
              </td>
            </tr>
