    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <!-- partial -->
          ...
          <div class="d">
          <div class="y">
          <center><h1 style="color:white">Update & Remove Snow Package Details</h1>
          <br><br><br><br>
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              ...
              <td>{{$data->price}}</td>
              <td>
                <a href="update15/{{$data->id}}" class="btn btn-primary" style="background-color:#2874f0;">Edit</a>
                <a href="delete15/{{$data->id}}" class="btn btn-danger">Delete</a>
              </td>
            </tr>
            @endforeach
          </tbody>
