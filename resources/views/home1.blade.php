 ...
 .imgg:hover 
 {
   ...
   <body>
      ...
      <h1><a href="home1" class="logo" id="travel"><img src="images/s1.jpg" width="40px" height="40px">&nbsp;&nbsp;Travel </a></h1>
       ...
       <!--  <div class="ss">
      <h3 class="search">    <button type="submit"><i class="fa fa-search"></i></button>
         <input type="text" placeholder="Search here..." name="yash"></h3>
...
<div class="carousel-inner">
         ...
         @foreach ($in as $data)
            ...
            <img src="{{ asset('images/'  . $data->image) }}"  class="d-block w-100" alt="..."  style="height:900px">
            ...
            @endforeach   
                  ...
                  <div class="carousel-item">
                     <img src="images/home-slide-2.jpg" class="d-block w-100" alt="..." style="height:900px">
                     <div class="carousel-caption d-none d-md-block">
                        <h5 class="content1">Explore, Discover, Travel</h5>
                        <p class="p1"><b>DISCOVER THE</b></p>
                        <p class="p2"><b>NEW PLACES</b></p>
                  ...
                  <div class="carousel-item">
                     <img src="images/home-slide-3.jpg" class="d-block w-100" alt="..." style="height:900px">
                     <div class="carousel-caption d-none d-md-block">
                        <h5 class="content1">Explore, Discover, Travel</h5>
...
<br><br><br><br>
      ...
      <section class="home-about">
         ...
         <div class="image">
              <div class="imgg">
            <img src="images/about-img.jpg" alt="" class="aa">
         </div>
         </div>

         <div class="content">
            <h3 style="color:white; font-size:100px">about us</h3>
         ...
         <div class="box-container">
            ...
            <div class="box">
               ...
               <div class="contentt">
                  ...
                  <a href="snow" class="btn">book now</a>
               </div>
            </div>
      ...
      <section class="home-offer">
         <div class="content">
            <h3>upto 50% off</h3>
            <p>Our all packages have more discount and more services</p>
            <a href="service" class="btn">Book now</a>
         </div>
      </section><br><br><br>
