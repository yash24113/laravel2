      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <!-- partial -->
         ...
         <div class="main-panel">
          <div class="d">
          <center><h1  style="color:white">Update & Remove Hawaii Package Details</h1>
          <br><br><br><br>
          <div class="y">
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              ...
              <td>{{$data->price}}</td>
              <td >
                <a href="update11/{{$data->id}}" class="btn btn-primary" style="background-color:#2874f0;">Edit</a>
                <a href="delete11/{{$data->id}}" class="btn btn-danger">Delete</a>
              </td>
            </tr>
            @endforeach
          </tbody>
