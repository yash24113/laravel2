...
<html lang="en">
  ...
  <div class="main-panel">
          <div class="d">
          <div class="y">
          <center><h1  style="color:white">Update & Remove Amazing Package Details</h1>
          <br><br><br><br>
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              ...
              <td>{{$data->price}}</td>
              <td>
                <a href="update12/{{$data->id}}" class="btn btn-primary" style="background-color:#2874f0;">Edit</a>
                <a href="delete12/{{$data->id}}" class="btn btn-danger">Delete</a>
              </td>
            </tr>
            @endforeach
          </tbody>
